...
class Preprocessor:
    ...
    def impute_missing_values(self, data, cols_with_missing_values):
        ...
        try:
            ...
            for col in self.cols_with_missing_values:
                # SimpleImputer expects 2D input; reshape the column and flatten the result back.
                imputed_values = imputer.fit_transform(self.data[[col]])
                self.data[col] = imputed_values.ravel()
    ...
    def handle_imbalanced_dataset(self,x,y):
        ...
        try:
            ...
            if hasattr(self.rdsmple, "fit_resample"):
